...
from enzyme_host_runtime.workspace import find_project_root
from enzyme_host_runtime.workspace import init_project
from enzyme_host_runtime.workspace import list_episode_ids
from enzyme_host_runtime.workspace import read_cli_state
...
def test_allocate_episode_id_is_deterministic(tmp_path: Path) -> None:
    ...
    assert list_episode_ids(context.root) == ["0001", "0002"]
