...
- 新 production attempt 使用 selected-chain `aox_blank_world_attempt_bundle@3`；
  历史 `@2` verifier 与 r48-r57 NO-GO evidence 保持冻结。r56 后的 target contract
