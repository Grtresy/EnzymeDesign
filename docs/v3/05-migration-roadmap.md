...
- 将 execution pipeline sandbox、artifact staging、tool contract compiler、多输入多输出和 pipeline 内 preprocess 能力纳入 Session 09 baseline
...
- pipeline preprocess 输出和 HPC declared outputs 都能回填为 session artifact
