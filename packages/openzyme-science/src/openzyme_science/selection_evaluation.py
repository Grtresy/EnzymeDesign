...
if TYPE_CHECKING:
    class ScientificOperationUniverse(Protocol):
        universe_digest: str
        occurrences: tuple[dict[str, Any], ...]


class ScientificSelectionRepositoryView(Protocol):
    """Read-only query ports required by selection evaluation."""
...
class ScientificSelectionEvaluator:
    repositories: ScientificSelectionRepositoryView
...
__all__ = [
    ...
    "ScientificSelectionIssue",
    "ScientificSelectionOccurrenceEvaluation",
    "ScientificSelectionRepositoryView",
]
