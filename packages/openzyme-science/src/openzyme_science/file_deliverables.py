...
from .deliverables import ScientificFileEffectAdoption
...
class ScientificDeliverableRepositoryView(Protocol):
    """Migration-only query/UoW view; replaced by task 12.4 participant commands."""

    scientific_selections: Any
    scientific_attempts: Any
    scientific_attempt_closures: Any
    scientific_dispositions: Any
    scientific_deliverables: Any
    controlled_operations: Any
    controlled_operation_executions: Any
    controlled_operation_results: Any
    workspace_revision_executions: Any
    verified_workspace_checkpoints: Any
    git_lfs: Any
    published_revisions: Any
    workspace_publication_remote_receipts: Any
...
class ScientificFileEffectAdoptionService:
    ...
    current_mutation_authority: Callable[[], Any]
    ...
    def adopt(
        ...
        *,
        ...
        authority = self.current_mutation_authority()
        ...
        if (
            ...
            or (
                ...
                and getattr(
                    workspace_result.terminal_state,
                    "value",
                    workspace_result.terminal_state,
                )
                != "succeeded"
        ...
        with self.repositories.atomic(prefix="scientific_file_effect_adoption"):
            current_authority = self.current_mutation_authority()
...
__all__ = [
    ...
    "ScientificDeliverableRepositoryView",
