...
class ScientificAttemptClosureRequestReader(Protocol):
    def get_by_attempt(
        self,
        attempt_id: str,
...
class ScientificAttemptClosureReader(Protocol):
    def get_by_attempt(self, attempt_id: str) -> ScientificAttemptClosure | None: ...


class ScientificAttemptLifecycleRepositoryView(Protocol):
...
class ScientificAttemptLifecycleResolver:
    repositories: ScientificAttemptLifecycleRepositoryView
...
__all__ = [
    ...
    "ScientificAttemptLifecycleRepositoryView",
