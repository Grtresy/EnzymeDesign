...
from openzyme_hpc import ExecutorHpcWorkspaceCleanupIntent
from openzyme_hpc import ExecutorHpcWorkspaceCleanupReceipt
from openzyme_hpc import ExecutorHpcWorkspaceProvisionIntent
from openzyme_hpc import ExecutorHpcWorkspaceProvisionReceipt
    ...
    def add_target_qualification(
        ...
        self.connection.execute(
            ...
            INSERT INTO executor_hpc_target_qualifications (
                ...
                workspace_root, sidecar_root_digest, inventory_generation,
                inventory_digest,
