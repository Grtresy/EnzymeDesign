...
from openzyme_science_research.legacy_bio import DeterministicLiteratureResearchService
...
def test_required_pubmed_rejects_deterministic_fixture_evidence() -> None:
    fixture = DeterministicLiteratureResearchService().search_pubmed_result(
