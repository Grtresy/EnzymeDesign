...
_EXPORT_MODULES = {
    ...
    "PODMAN_QUALIFICATION_OPERATIONS": "qualification",
    "PodmanQualificationOperationPort": "qualification",
    "PodmanQualificationProbeBridge": "qualification",
    "PodmanQualificationCommandPort": "qualification",
    "PodmanQualificationState": "qualification",
    "PodmanScientificQualificationRoute": "qualification",
    "ScientificQualificationInputResolver": "qualification",
    "SubprocessPodmanQualificationCommandPort": "qualification",
    "SubprocessPodmanQualificationOperation": "qualification",
    "QUALIFICATION_IMAGE_GROUPS": "qualification_images",
    "QUALIFICATION_IMAGE_MANIFEST_SCHEMA": "qualification_images",
    "QualificationImageCommandPort": "qualification_images",
    "QualificationImageManifest": "qualification_images",
    "PodmanQualificationImagePreparationExecutor": "qualification_images",
