...
# Historical receipt identity is retained byte-for-byte even though the physical
# resource owner moved to openzyme-store-sqlite. Changing it would invalidate every
# already sealed fresh-install receipt; the @2 offline cutover defines a new proof.
