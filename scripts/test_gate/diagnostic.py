...
CONTRACT_GROUPS: Mapping[str, ContractGroup] = MappingProxyType(
    {
        "compatibility_audit": ContractGroup(
            ...
            pytest_selectors=(
                "packages/openzyme-kernel/tests/test_compat_caller_audit.py",
            ),
        ),
        "test_gate": ContractGroup(
            ...
            pytest_selectors=(
                "packages/openzyme-kernel/tests/test_test_gate_affected.py",
                "packages/openzyme-kernel/tests/test_test_gate_authoritative.py",
                "packages/openzyme-kernel/tests/test_test_gate_benchmark.py",
                "packages/openzyme-kernel/tests/test_test_gate_config.py",
                "packages/openzyme-kernel/tests/test_test_gate_contract.py",
                "packages/openzyme-kernel/tests/test_test_gate_diagnostic.py",
                "packages/openzyme-kernel/tests/test_test_gate_model.py",
                "packages/openzyme-kernel/tests/test_test_gate_pytest_plugin.py",
                "packages/openzyme-kernel/tests/test_test_gate_replay.py",
                "packages/openzyme-kernel/tests/test_test_gate_resource.py",
                "packages/openzyme-kernel/tests/test_test_gate_runner.py",
                "packages/openzyme-kernel/tests/test_test_gate_shadow.py",
                "packages/openzyme-kernel/tests/test_test_gate_source.py",
            ),
        ),
        "v3_runtime_protocol": ContractGroup(
            id="v3_runtime_protocol",
            lint_paths=("packages/openzyme-kernel",),
            pytest_selectors=(
                "packages/openzyme-kernel/tests/test_runtime_coordination_application.py",
                "packages/openzyme-kernel/tests/test_protocol_application.py",
            ),
        ),
    }
)
