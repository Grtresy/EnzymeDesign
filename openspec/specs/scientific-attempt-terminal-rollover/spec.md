# scientific-attempt-terminal-rollover

## Purpose
Define the typed Core projection and bounded AOX coordination for the monotonic handoff from a scientific-attempt mutation scope to its deterministic post-closure session scope.
