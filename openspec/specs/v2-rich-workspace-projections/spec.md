...
- artifact workspace summaries
- focused artifact state and execution-facing readiness information
...
### Requirement: Host streaming exposes Phase C workflow, evidence, and artifact-workspace updates
...
- artifact-workspace updates
- execution-result updates that are consumed by the design loop
...
- **THEN** the browser can update workflow, evidence, design workspace, and execution-result panes in place

### Requirement: Web workspace renders richer workflow, evidence, and design-workspace panes from Host projections
...
- execution-facing artifact context and recent execution outcomes

#### Scenario: User reviews Phase C workspace state
- **WHEN** a user opens or watches a workspace during research or design
- **THEN** the Web UI renders workflow, evidence, and design-workspace information from Host projections
...
#### Scenario: Evidence or artifact workspace changes
- **WHEN** canonical research evidence or artifact workspace state changes
