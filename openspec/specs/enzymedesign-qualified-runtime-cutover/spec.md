# enzymedesign-qualified-runtime-cutover Specification

## Purpose
定义 EnzymeDesign 如何把当前有效的真实 Batch 1 资格 receipt 安全采用为 owner-local runtime deployment，并保持双源码、一次性 authority、可恢复 activation 与 first-live 单向边界。
